"""Conformance gate for THIS candidate — runs inside its own `bench-<name>` env:

    conda run -n bench-<name> python -m pytest logic/oli/reason/localization/realizations/<name>/
