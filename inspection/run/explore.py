...
Usage:
    python -m inspection.run.explore run --outdir=data/inspection/explore1
"""
...
from inspection.perception.capture import WRIST_SERIAL, save_bundle
from inspection.cell.geometry import CloudAccumulator, object_from_view
from inspection.view.viewsphere import (
