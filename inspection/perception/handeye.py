...
Usage:
    python -m inspection.perception.handeye collect --outdir=data/inspection/handeye
    python -m inspection.perception.handeye solve   --outdir=data/inspection/handeye
...
from inspection.perception.capture import WRIST_SERIAL
...
def collect(outdir: str, serial: str = WRIST_SERIAL,
    ...
    print(f"\n{idx} pairs total. Solve with:\n"
          f"  python -m inspection.perception.handeye solve --outdir={outdir}")
