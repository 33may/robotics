...
Usage:
    python vbti/utils/colmap_utils.py reconstruct --frames_dir data/frames --output_dir data/colmap
    python vbti/utils/colmap_utils.py run_colmap --frames_dir data/frames --output_dir data/colmap
    python vbti/utils/colmap_utils.py validate_models --colmap_dir data/colmap
    python vbti/utils/colmap_utils.py undistort --colmap_dir data/colmap --output_dir data/colmap_undistorted
"""
