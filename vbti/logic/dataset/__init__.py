...
def __getattr__(name):
    ...
    if name in ("load_and_split_dataset", "create_dataloaders"):
        from .loading_utils import load_and_split_dataset, create_dataloaders
        return {"load_and_split_dataset": load_and_split_dataset,
                "create_dataloaders": create_dataloaders}[name]
