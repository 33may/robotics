...
Commands:
    ...
    python -m vbti.logic.reconstruct.cosmos_transfer.py capture \
        --dataset_file=./datasets/vbti_table_v1/vbti_dataset_v1.hdf5 \
        --episode=33

    # Step 2: Convert captured frames → mp4 videos + edge maps
    python -m vbti.logic.reconstruct.cosmos_transfer.py process --episode=33

    # Step 3: Generate Cosmos Transfer config JSON
    python -m vbti.logic.reconstruct.cosmos_transfer.py config \
        --episode=33 \
    ...
    python -m vbti.logic.reconstruct.cosmos_transfer.py transfer --episode=33 --variant=kitchen

    # Step 5: Reassemble augmented frames back into HDF5
    python -m vbti.logic.reconstruct.cosmos_transfer.py reassemble --episode=33 --variant=kitchen
"""
